...
**技术栈：** TypeScript (67.2%) | JavaScript (15.5%) | CSS (13.4%) | HTML (3.5%)

一个融合传统音乐播放与个性化榜单创作的平台，不仅是播放器，更是你的音乐灵魂伴侣！
...
完整的外卖订餐系统后端实现，涵盖用户管理、订单处理、菜品管理等核心功能模块。
